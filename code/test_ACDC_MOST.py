...
def Inference(FLAGS):
    ...
    for case in image_list:
        ...
        print(case, first_metric[0], second_metric[0], third_metric[0], "Avg:", (first_metric[0]+second_metric[0]+third_metric[0])/3)
...
if __name__ == '__main__':
    ...
    FLAGS.root_path = os.path.join(FLAGS.root_path, 'acdc') # for LA dataset
    metric, test_save_path = Inference(FLAGS)
    print("dice, jc, hd95, asd")
    print(metric)
